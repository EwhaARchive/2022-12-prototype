...
- Cyan 색상의 요소가 없을 경우 화면에 적힌 문구 또는 표시를 따라 진행합니다. (예: Cyan 색상의 요소가 없고, 특정 요소를 터치하라는 문구가 있는 경우, 그 요소를 찾아 터치. Cyan 색상의 요소가 없고, 손가락 모양의 터치 아이콘이 있을 경우, 손가락이 있는 부분을 터치.)
